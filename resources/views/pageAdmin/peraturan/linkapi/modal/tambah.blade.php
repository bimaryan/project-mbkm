<div id="tambah-kelas" tabindex="-1" aria-hidden="true" data-modal-backdrop="static"
    ...
    <div class="relative w-full max-w-2xl max-h-full p-4">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form action="{{ url('settings/link-api') }}" class="p-4 md:p-5" method="POST">
                @csrf
                <div class="gap-2">
                    <div class="mb-2">
                        <label for="link_api" class="block text-sm font-medium text-gray-700">Link API</label>
                        <input type="text" name="link_api" id="link_api" placeholder="Link API"
