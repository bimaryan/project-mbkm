<div id="tambah-matakuliah" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-2xl max-h-full p-4">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form action="{{ route('data-mata-kuliah.proses') }}" class="p-4 md:p-5" method="POST">
                ...
                <div class="gap-2">
                    <div class="mb-2">
                        <label for="kode_mata_kuliah" class="block text-sm font-medium text-gray-700">Nama Mata
                            Kuliah</label>
                    ...
                    <div class="mb-2">
                        <label for="mata_kuliah" class="block text-sm font-medium text-gray-700">Nama Mata
                            Kuliah</label>
