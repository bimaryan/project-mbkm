<div class="relative overflow-x-auto sm:rounded-lg">
    <table class="w-full text-sm text-center text-gray-500 display dark:text-gray-400" style="100%" id="data-matakuliah">
                    ...
                    <td scope="col" class="flex items-center justify-center gap-2 px-6 py-4">
                        <div>
                            <form id="delete-form-{{ $data->id }}"
                                action="{{ route('data-mata-kuliah.delete', $data->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
