<div class="relative overflow-x-auto sm:rounded-lg">
    <table class="w-full text-sm text-gray-500 display dark:text-gray-400" style="100%" id="data-dokuemenspo">
        <thead class="uppercase text-cen-gray-700 dark:text-gray-400">
            <tr>
                <th scope="col" class="px-6 py-3">No</th>
                <th scope="col" class="px-6 py-3">Dokumen SPO</th>
            ...
            {{-- @foreach ($kelas as $data) --}}
                <tr
                    ...
                    <td scope="col" class="flex items-center justify-center gap-2 px-6 py-4">
                        <div>
                            <form id="delete-form"
                                action="" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
