<div class="relative overflow-x-auto sm:rounded-lg">
    <table class="w-full text-sm text-center text-gray-500 display dark:text-gray-400" style="100%" id="data-kategori">
                    ...
                    <td scope="col" class="flex items-center justify-center gap-2 px-6 py-3">
                        <div>
                            <form id="delete-form-{{ $data->id }}"
                                action="{{ route('data-kategori.hapus', $data->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
