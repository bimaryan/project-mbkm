                ...
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <button data-modal-target="import-satuan" data-modal-toggle="import-satuan"
                            class="justify-center px-4 py-2 text-white bg-green-500 rounded hover:bg-green-800" data-tooltip-target="import"
                        ...
                        {{-- MODAL TAMBAH SATUAN --}}
                        @include('pageStaff.satuan.modal.import')
                        ...
                        {{-- MODAL TAMBAH SATUAN --}}
                        @include('pageStaff.satuan.modal.tambah')
                    </div>
                </div>
            </div>
            ...
            function loadTable(page = 1) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#tableSatuan').html($(response).find('#tableSatuan').html());
