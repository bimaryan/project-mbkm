        ...
        <div class="rounded-lg mt-14 space-y-4">
            ...
            <div class="p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-between items-center">
                    <div>
                        <h3 class="text-2xl text-green-500 font-semibold">Data Satuan</h3>
                    </div>
                    <div>
                        ...
                        <div id="satuan" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <!-- Modal body -->
                                    <form action="{{ route('data-satuan.proses') }}" class="p-4 md:p-5" method="POST">
                                        @csrf
                                        <!-- Nama Satuan -->
                                        <div class="mb-2">
                                ...
                                <div id="edit{{ $data->id }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <!-- Modal body -->
                                            <div class="p-4">
                                                <form action="{{ route('data-satuan.edit', $data->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <!-- Nama Satuan -->
                                                    <div class="mb-2">
