        ...
        <div class="rounded-lg mt-14 space-y-4">
            ...
            <div class="p-4 rounded-lg shadow-lg bg-white">
                <div class="relative overflow-x-auto sm:rounded-lg">
                    <table id="barangs-table" class="w-full text-sm text-center text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase dark:text-gray-400">
                            <tr>
                                <th class="py-6 px-3">No</th>
                                <th class="py-6 px-3">Nama Barang</th>
                                <th class="py-6 px-3">Kategori</th>
                                <th class="py-6 px-3">Kondisi</th>
                                <th class="py-6 px-3">Stock</th>
                                <th class="py-6 px-3">Satuan</th>
                                <th class="py-6 px-3">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
